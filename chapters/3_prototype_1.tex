...
Finally, the Cronbach's Alpha test revealing that the questions developed for evaluating CE and AE ($\alpha$=.80) were appropriate for their purpose.

\subsubsection{Discussion}
In the present study, we analyzed how metahumans were able to convey the same emotional depth as a real person (\textbf{RQ\textsubscript{1}}). We wanted to see if our independent variable stimulus---metahuman (G\textsubscript{1}), real person (G\textsubscript{2}), and transcript (G\textsubscript{3})---had any influence on participants' cognitive and affective empathy.
