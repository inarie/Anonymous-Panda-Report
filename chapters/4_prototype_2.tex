...
\centering
\caption{View of hands in DMD mode \cite{ULTP}}
\label{fig:DMD}
\end{figure}
...
Our research model is summarized in Figure \ref{fig:TAModel}, which also shows the hypothesized relationships between the variables.

\begin{figure}[!htb]
\includegraphics[width=0.8\textwidth]{figures/TAM.png}
\centering
\caption{Our research model}
\label{fig:TAModel}
\end{figure}
